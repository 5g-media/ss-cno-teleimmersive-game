...
def run_rl_agent(mdp_conf):
    ...
    for msg in consumer:
        ...
        # TODO: Remove. Collect only for conference version
        measurements['client_id'] = spectator.client_id
        measurements['transcoder_no'] = transcoder_no
        measurements['timestamp'] = payload['timestamp']

        # Compute QoE and publish
        # TODO: Try with both PSNR-based and ITU
        # qoe_itu = compute_vq_itu(measurements['framerate_on'], measurements['bitrate_on'])
